...
FULL_PATH=/home/pi/radiation-benchmarks/src/openmp/quicksort

MAX_CLOCK=2500 #Clock maximo permitido INCLUSIVO
MIN_CLOCK=1000 #Clock minimo permitido (Rasp 4 é 600)
INCREMENTO_CLOCK=50 #Passo entre cada incremento de clock

MAX_TENSAO=8 #Tensao maxima permitida (Rasp 4 é 8) INCLUSIVO
MIN_TENSAO=0 #Tensao minima permitida (Rasp 4 é -16)
...
if test $TENSAO -ne $ACABOU; then
    ...
    ${FULL_PATH}/quick_check 100000000 4 ${FULL_PATH}/inputsort_100000000 ${FULL_PATH}/gold_100000000 10000 &
